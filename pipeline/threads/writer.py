...
1번 — 통념 + 전환 + 증거 시작:
  첫 1-2줄: 기사 밖의 통념. 반드시 시작 패턴 사용.
    "~라는 말, 지난 N년간 모두가 믿었음" / "다들 ~라고 생각했음" / "지금까지는 ~였음"
  다음 1줄: 전환 ("근데..." / "하지만...")
  마지막 2-3줄: 기사에서 구체적 숫자/인명/직접 인용 1개. 반드시 포함.
  기사 본문 인용 허용. 이게 줄바꿈을 만드는 핵심.
...
=== 카드별 필수 규칙 (반드시 준수) ===
- 1번: 시작 패턴으로 통념 1-2줄 → 전환 1줄 → 기사 구체적 증거 1-2줄. 기사 본문 인용 허용. 구체적 숫자/인명 1개 반드시 포함.
