...
def _build_pass1_user_prompt(pitch: dict, all_articles: list) -> str:
    ...
    return (
        ...
        "- category: 아래 5개 중 하나를 선택한다. 기사의 핵심 주제가 어디에 해당하는지 판단한다.\n"
        "  - tech: 기술 자체(알고리즘, 하드웨어, 소프트웨어, 인프라)가 주제인 기사. AI 기술의 작동 원리, 성능 비교, 기술적 한계가 핵심이면 tech\n"
        "  - business: 기업 전략, 투자, 인수합병, 매출, 시장 점유율이 주제인 기사. AI 기업의 사업 확장, 자금 조달, IPO, 파트너십도 여기에 해당\n"
        "  - society: 정책, 규제, 법률, 윤리, 고용 영향, 국제 관계가 주제인 기사. 미중 AI 협상, EU AI Act, AI 세금/규제도 여기에 해당\n"
        "  - culture: 콘텐츠, 미디어, 예술, 교육, 일상 생활 변화가 주제인 기사. AI 생성 콘텐츠, AI 교육 도구, 일상 활용이 핵심이면 culture\n"
        "  - science: 학술 논문, 실험 결과, 기초 연구가 주제인 기사. 연구 성과, 논문 발견, 실험 데이터가 핵심이면 science\n"
        "  판단이 어려울 때: AI 기업 소식이라도 'AI 기술 자체'가 아니면 business/society 우선 고려\n"
