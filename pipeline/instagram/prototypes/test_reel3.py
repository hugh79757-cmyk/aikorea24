...
# Write filter graph to a file to avoid shell escaping issues
filter_graph = """
...
[2:v]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,zoompan=z='if(gte(zoom,1.12),1.12,zoom+0.0015)':d=75:s=1080x1920:fps=30[v2];
[3:v]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,zoompan=z='if(gte(zoom,1.12),1.12,zoom+0.0015)':d=75:s=1080x1920:fps=30[v3];
[4:v]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,zoompan=z='if(gte(zoom,1.12),1.12,zoom+0.0015)':d=75:s=1080x1920:fps=30[v4];
[v0][v1]xfade=transition=wipeleft:duration=0.4:offset=1.9[v01];
[v01][v2]xfade=transition=dissolve:duration=0.35:offset=3.8[v012];
[v012][v3]xfade=transition=circlecrop:duration=0.4:offset=5.7[v0123];
[v0123][v4]xfade=transition=dissolve:duration=0.4:offset=7.6[vout];
