...
[출력 형식]
다음 5단락 구조로 작성하세요. 각 소제목(H2)은 해당 단락 내용을 자연스러운 한국어 문장이나 구문으로 요약하세요. 'A측', 'B측', '대비', '측:' 같은 기계적 라벨이나 구조 지시어를 소제목에 절대 사용하지 마세요.

TITLE: SEO 친화적 제목 (25자 이내)

--- (구분선)

## [도입부 소제목: 이 대비가 왜 주목할 만한지 한 문장으로, 예: "효율성과 인간 가치, 맞서 있는 두 시각"]
도입부: 왜 이 주제가 주목할 만한지 소개 (2-3문장)

## [기사 1 측 입장을 자연스러운 소제목으로, 예: "플랫폼의 거래 편의성 증대"]
기사 1의 핵심 내용 요약 + 원문 인용 (3-4문장)

## [기사 2 측 입장을 자연스러운 소제목으로, 예: "금융 당국의 소비자 보호 경고"]
기사 2의 핵심 내용 요약 + 원문 인용 (3-4문장)

## [분석 소제목을 자연스러운 문장으로, 예: "충돌이 생긴 배경"]
근거 기반 추론. "~할 수 있다", "~가능성이 있다" 표현 사용.
구체적 숫자나 고유명사를 새로 만들지 마세요. (3-4문장)

## [전망 소제목을 자연스러운 문장으로, 예: "향후 전망"]
falsifiable한 전망 제시. 구체적 future 뉴스 이벤트로 검증 가능해야 함. (2-3문장)
...
5. 구체적 숫자, 고유명사, 통계를 새로 만들지 마세요.
6. 한국어로 작성하세요.
7. 원문 기사 링크를 글 하단에 포함하세요.
8. 제목은 25자 이내, SEO 친화적으로 작성하세요.
9. [중요] 모든 인용문은 반드시 위 원문 근거에서 발췌한 것이어야 합니다. 2차 해석, 일반적 지식, 재구성된 문장은 절대 사용하지 마세요. 인용문이 원문에 존재하지 않으면 해당 인용은 따옴표 없이 서술형으로 작성하세요."""
